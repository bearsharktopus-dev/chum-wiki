...
> Russian-American metahuman and navigator/tech specialist of the Tacony Titans, possessing magnetic sense abilities and a talent for repurposing scavenged technology.

## Infobox

| Field | Value |
|-------|-------|
| **Full Name** | Natasha Sokolov |
| **Aliases** | Compass |
| **Date of Birth** | Unknown |
| **Age** | 19 |
| **Gender** | Female |
| **Ethnicity** | Russian-American |
| **Place of Birth** | Unknown (Russian immigrant family) |
| **Residence** | Tacony, Philadelphia, PA |
| **Affiliation** | Tacony Titans |
| **Former Affiliations** | N/A |
| **Occupation** | Navigator, Tech Specialist, Vigilante |
| **Status** | Active |
...
- **Magnetic Sense** — Possesses an innate magnetic sense that functions as a biological compass, allowing her to perceive magnetic fields and orient herself with precision. This ability makes her a natural navigator, capable of maintaining directional awareness in any environment.
- **Small Metal Object Manipulation** — Can manipulate small metal objects with enough telekinetic force to cause damage. The upper limit of object size and force output is not documented, but the ability is described as effective in close-quarters situations.
- **Localized Electronics Disruption** — Can disrupt electronic devices within a localized area, interfering with signals, short-circuiting equipment, or disabling surveillance systems. The exact range and duration of this disruption are not specified.

### Limitations

- The scale of her metal manipulation is limited to small objects; she does not exhibit large-scale ferrokinesis.
- The range of her electronics disruption is localized, suggesting it requires proximity to the target device.
- Specific upper limits of her magnetic sense range and the force ceiling of her metal manipulation are not documented.
- She is a baseline human in terms of physical durability, lacking enhanced strength, regeneration, or other secondary physical enhancements.
...
|------|------|------------|
| Book 2: Keys | Mentioned | The Tacony Titans, including Compass, are first referenced by name in Chapter 17 when Sam's school friends discover the team's website. Compass is listed as a team member alongside Bubble, Weave, Sandman, and Sundial. |
| Book 5: Mayfly | Supporting | First on-page appearance in Chapter 80 during the alliance formation meeting at the Tacony Titans' garage headquarters, where she introduces herself and her magnetic field control abilities. Participates in the weeklong stakeout of Squeal's apartment and the Dobson Mills warehouse. Present during the chaotic warehouse battle against Squeal, Sparkplug, and their henchmen in Chapter 81, fighting alongside Moonshot. Assists in devising a cover story to protect Kate's vigilante identity in the aftermath (Chapter 82). Attends the combined strategy session between the Auditors, Tacony Titans, and Team Mayfly at the Music Hall in Chapter 83. Present during planning for the Sparkplug capture operation in Chapter 84. |
| Book 6: Sideshow | Mentioned | The Tacony Titans are referenced during the broader alliance discussions involving Philadelphia's hero teams, including the combined meeting of the Delaware Valley Defenders, Young Defenders, and Tacony Titans addressing the Rogue Wave threat. |
| Book 7: Security | Mentioned | Dr. Mikhail Sokolov, who shares Natasha's surname, appears as a figure in Chapter 96 during the Chernobyl trial proceedings. Whether a familial connection exists is unconfirmed. The Tacony Titans continue to operate in the background of the broader Philadelphia hero landscape. |
...
- character reference guide.txt — Core biographical details, power description, personality traits, family background, team affiliation, and current status.
- THE CANON DOCUMENT 1 & 2.txt — First mention of Tacony Titans and Compass by name in Chapter 17 via Sam's friends viewing the team's website.
- THE CANON DOCUMENT 4 POINT 5 & 5.txt — First on-page appearance in Chapter 80 alliance formation meeting, Dobson Mills warehouse battle in Chapter 81, aftermath and cover story in Chapter 82, combined strategy session in Chapter 83, and Sparkplug capture planning in Chapter 84.
- THE CANON DOCUMENT 6 & 7.txt — Dr. Mikhail Sokolov's appearance in Chapter 96 during the Chernobyl trial.
- THE CANON DOCUMENT 8 AND 9.txt — Arrival with Moonshot to support arson investigation in Chapter 140.
- THE CANON DOCUMENT 12 AND 13.txt — Referenced in Chapter 184 as considering moving operations underground due to the Argus Corps bounty system; Tacony Titans' role in Arc 12's three-faction conflict.
- THE CANON DOCUMENT 14 AND 15.txt — Blizzard crisis response in Chapter 229, joint Titans-Auditors communication channel established.
- THE FACTSHEET.txt — PERKS classification system and power category definitions referenced for context.

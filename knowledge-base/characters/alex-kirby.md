...
| **Residence** | Philadelphia, Pennsylvania (recently relocated) |
...
- character reference guide.txt — Core biographical details, power description, personality profile, family background, current status, and program affiliation.
- THE CANON DOCUMENT 14 AND 15.txt — First appearance in Chapter 215 (mentorship meeting and power demonstration), mentorship sessions at Parkway Central Library and Franklin Park, Chapter 221 (mentorship at Sam's house), Chapter 222 (Pennypack Park training and fire demonstration), Chapters 225/228-231 (Rittenhouse Square fire sighting, blizzard crisis, warehouse raid revelation, Interlude AK.1 warehouse raid, debriefing and benching, mentorship career discussions and power practice).
- THE CANON DOCUMENT 16 AND 17.txt — Chapter 234 (community center grand opening, lurking near cookies), Chapter 235 (Valentine's Day visit, asks Sam out, community center activities), Chapter 237 (Sam realizes parallel between her behavior and benching Alex), Chapter 240 (Songbird attack on community center, Alex pacing and furious, parents send taxi, de-escalation speech).

...
> Leader of the Tacony Titans and psychometric investigator whose time-perception abilities make her one of Northeast Philadelphia's most effective vigilante strategists.
...
| **Affiliation** | Tacony Titans (Leader) |
| **Former Affiliations** | N/A |
| **Occupation** | Vigilante, Investigator (also presumably attending school or working) |
| **Status** | Active |
...
??? note "Powers & Abilities"
    ...
    **Abilities**
    ...
    - **Psychometry** - Lucy can "read" locations by experiencing events that occurred there up to 24 hours in the past. This manifests as a sensory movie, allowing her to witness past actions in detail sufficient to identify individuals, describe their behavior, and reconstruct timelines. She used this ability to confirm Aaron McKinley as the arsonist behind the Philadelphia fire crisis by reading the burned coffee shop site, and to investigate Jump distribution operations at the Sunoco station in Tacony.
    - **Short-Range Precognition** - Can perceive up to five seconds into the future, granting her a significant advantage in combat and tactical situations. She displayed momentary precognitive awareness during the Dobson Mills warehouse stakeout and uses this ability in conjunction with her martial arts training to anticipate and counter attacks.
    - **Precognition Chaining** - Can extend her precognitive window indefinitely by "chaining" successive five-second glimpses into a continuous vision of the future. However, this locks her physically to the area where the chaining began; she cannot leave until the predicted timeframe has passed, as departing would create causality issues. She is physically unable to move from the location during this process.
    - **Photographic Memory** - Possesses total recall, which enhances both her investigative capabilities and her ability to provide detailed intelligence. This ability allowed her to produce an accurate sketch of Aaron McKinley from her psychometric vision, which was subsequently broadcast on the news and confirmed Aaron's identity.

    **Limitations**

    - Lucy's powers are perception-based and provide no physical enhancements; she is a baseline human in terms of durability, strength, and recovery.
    - Psychometry is limited to a 24-hour window and requires her physical presence at the location she wishes to read.
    - Precognition chaining, while theoretically indefinite, renders her immobile and vulnerable for the duration of the predicted timeframe.
    - She was injured during the Dobson Mills warehouse battle, requiring Bubble's protective force fields and Sam's direct intervention to keep her safe.
...
??? warning "Book 2: Keys"
    ...
    **Role:** Mentioned
    ...
    The Tacony Titans are referenced during a gathering at Kate's house in September 2023. Lilly mentions them as a local superhero team her father encountered, and the group views the Titans' basic website listing members including Sundial.
...
??? warning "Book 9: Sheol"
    ...
    **Role:** Supporting
    ...
    Uses psychometry to investigate the burned coffee shop site in Chapter 140, providing a detailed description of the arsonist matching Aaron McKinley. Produces a sketch of Aaron that is broadcast on the news, confirming his identity. Offers to have Sandman watch Sam's neighborhood. Arrives with Moonshot and Compass to provide additional support during the investigation.

??? warning "Book 10: Plume"

    **Role:** Mentioned

    The Tacony Titans assist with covering neighborhood patrols while Sam is grounded, maintaining community protection in the Auditors' reduced capacity.
...
- character reference guide.txt - Core biographical details, power descriptions, personality traits, team role, family background, and current status.
- THE CANON DOCUMENT 1 & 2.txt - First mention of the Tacony Titans via their website, listing original roster including Sundial.
- THE CANON DOCUMENT 4 POINT 5 & 5.txt - First on-page appearance in Chapter 70 (Wissinoming Park encounter), Ricochet battle reinforcement in Chapter 72, post-battle confrontation in Chapter 73, alliance proposal in Chapter 79, alliance formation and Dobson Mills operations in Chapters 80-81, warehouse battle aftermath in Chapter 82, Team Mayfly role negotiation in Chapter 83, and Sparkplug confrontation in Chapter 84.
- THE CANON DOCUMENT 8 AND 9.txt - Briefing attendance and zoo heist intelligence sharing in Arc 8; psychometric investigation of coffee shop fire, Aaron McKinley sketch, and arson investigation support in Arc 9.
- THE CANON DOCUMENT 10 AND 11.txt - Tacony Titans covering patrols during Arc 10.
- THE CANON DOCUMENT 12 AND 13.txt - Safer Streets Initiative warning, inter-team coordination proposal, and Jump activity report in Arc 12; Tacony Titans faction identification in Arc 12 synopsis; Moonshot patrol observation in Arc 13.
- THE CANON DOCUMENT 14 AND 15.txt - Shrike crisis bird sighting report in Arc 14; Sunoco station infiltration and psychometry investigation, combat with Marathon's crew, Sam extraction support, Bellwether intelligence distribution, and psychometry deterrent in Arc 15.
- THE CANON DOCUMENT 16 AND 17.txt - Winter storm crisis response, joint communication channel establishment, and Bellwether operation planning in Arc 16.

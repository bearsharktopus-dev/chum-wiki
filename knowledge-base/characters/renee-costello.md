...
> Intelligence specialist and capture operative for Rogue Wave, a ferrokinetic with power-detection abilities and deep ideological commitment to anarchist revolution.

## Infobox

| Field | Value |
|-------|-------|
| **Full Name** | Renee Costello |
| **Aliases** | Ren, Dead Drop, Drop |
| **Date of Birth** | Unknown |
| **Age** | 23 |
| **Gender** | Female |
| **Ethnicity** | Unknown |
| **Place of Birth** | Unknown |
| **Residence** | Philadelphia, PA (Rogue Wave safehouse) |
| **Affiliation** | Rogue Wave |
| **Former Affiliations** | N/A |
| **Occupation** | Intelligence operative, capture specialist |
| **Status** | Active |
...
- The power radar does not convey direction or identify which individual possesses the detected abilities, limiting its tactical precision in crowded environments.
- Her ferrokinesis appears to require existing metal in the environment to manipulate; she is not observed creating metal from nothing.
- She is a baseline human in terms of physical durability and does not possess enhanced strength, speed, or regeneration.
- When struck in the hand by a slingshot projectile (by Blink during the Sunoco station confrontation), she lost control of her chains, suggesting that pain or physical disruption can interfere with her metal manipulation.
...
- character reference guide.txt — Core biographical details, power descriptions, personality traits, role within Rogue Wave, age, codename, current status, and ideological characterization.
- THE CANON DOCUMENT 10 AND 11.txt — First appearance during NBC10 broadcast (Chapter 158), identification as core Rogue Wave member, Rogue Wave manifesto events, and Interlude LS.1 strategic planning meeting where Dead Drop provides intelligence on Kingdom operations.
- THE CANON DOCUMENT 12 AND 13.txt — Bus encounter with Sam (Chapter 180), Sunoco station capture of Bloodhound (Chapters 181-182), chain restraint confrontation, extraction by Rush Order, identification by Tasha from broadcast footage, South Street aftermath team discussion, and Arc 12/13 synopsis references.
- THE CANON DOCUMENT 14 AND 15.txt — Mr. Polygraph extraction operation (Rush Order interlude chapter), selection for combat team, chain subdual of Kingdom operatives at Roxborough Memorial, Rogue Wave protection arrangement with Sam, surveillance photos of Shrike's followers, Arc 14/15 synopsis references, and tainted Jump crisis context.
- dc-3.txt (scraped) — Interlude DC.3 from Intermission 15.5: This Side Up. Dead Drop partners with Rush Order to track Maya Richardson to a Northeast Philadelphia rooftop during a blizzard. Provides detailed account of Dead Drop's ferrokinetic chain attacks against Maya, the stairwell pressure confrontation, Dead Drop tearing a fire door off its hinges to break Maya's pressure seal, and the subsequent tactical debrief at the Camden safehouse.
- THE CANON DOCUMENT 16 AND 17.txt — Current status spreading Maya Richardson intelligence, Mr. Antithesis rampage context, and ongoing Rogue Wave operations.

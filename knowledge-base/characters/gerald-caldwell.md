...
| Field | Value |
|-------|-------|
| **Full Name** | Gerald "Jerry" Caldwell |
| **Aliases** | Jerry |
| **Date of Birth** | Unknown |
| **Age** | Upper-middle-aged |
| **Gender** | Male |
| **Ethnicity** | Black |
| **Place of Birth** | Unknown |
| **Residence** | Philadelphia, PA (presumed) |
| **Affiliation** | Independent (defense attorney) |
| **Former Affiliations** | N/A |
| **Occupation** | Defense Attorney (specializing in metahuman/superhuman cases) |
| **Status** | Active |
| **First Appearance** | Interlude IF.2 (Intermission 4.5: Amnion) |
| **Last Appearance** | Chapter 234 (possibly; see Trivia) |
...
Gerald Caldwell has no metahuman abilities. His expertise is entirely legal and interpersonal.
...
|------|------|------------|
| Intermission 4.5: Amnion | Supporting | First appearance in Interlude IF.2 (Illya's POV). Arrives at Illya's containment cell with paralegal Riya Kapoor. Forgoes protective gear as a gesture of trust while Riya wears full hazmat equipment. Introduces himself as "Jerry Caldwell." Discusses strategy under attorney-client privilege, focusing on a necessity defense arguing Illya's actions were taken "to avoid greater harm." Confirms Sam is "alive and recovering well" and suggests avoiding calling her as a witness. Illya is moved to tears by the offer of genuine help. |
| Book 5: Mayfly | Supporting | Represents Illya at his federal court arraignment (Interlude IF.3). Illya pleads not guilty on a necessity defense. Caldwell stands beside Illya at the defense table, described as "a monolith amidst the tempest." |
| Book 6: Sideshow | Supporting | Cross-examines Sam during her formal deposition (Ch. 87), conducting thorough and emotionally taxing questioning that Sam later describes as "emotional sandpaper on an open wound." At trial (Ch. 94-96), introduces Liberty Belle's handwritten note and will as evidence suggesting Belle may have provoked the confrontation with Illya. Challenges prosecution experts on Day 7 with data showing decreasing radiation levels as evidence of Fedorov's containment efforts. Guides Illya's testimony on Day 8. Aggressively cross-examines NSRA Agent Evelyn Shaw on Day 9, exposing the government arrangement and presenting emails about keeping "Asset Chernobyl happy." Referenced in Interlude BA.1 where DVD leadership discusses him as a formidable legal opponent. |
| Book 7: Security | Minor | Present during the courthouse attack when the Phreaks assault the building. Stands alongside Mrs. Gibson in shared concern for the safety of those under their charge. Agrees with Crossroads about keeping Illya away from Deathgirl to avoid escalation (Interlude IF.4). |
| Book 15: Severe Weather Warning | Supporting | Hired by Rachel and Benjamin Small to represent Sam during her fugitive arc. Sam learns of his involvement through her parents' voicemail relayed by Lily: "We've hired Jerry Caldwell, he's handled superhuman cases before." Sam notes: "That was Chernobyl's lawyer. So he'll know me. Good" (Ch. 225). Caldwell communicates through Lily's family relay that "the case is weak" and "tracker data is holding up as alibi evidence" (Ch. 226). Arrives at approximately 7 AM on the Monday of Sam's release, drives her home, and goes over monitoring conditions: GPS 24/7, check-ins at 8 AM and 8 PM, hearing on February 3 (Chs. 227-228). Stays for dinner at the Small house, discusses weapons cache and federal de-gunning initiatives, compliments Sam's parents. Advises against EMT work during release conditions (Ch. 228). Tells Sam "Don't make me regret this" when she asks about walking around her neighborhood (Ch. 229). Preps Sam for her hearing, which results in a disorderly conduct plea with time served and ankle monitor removal (Ch. 231). Tells Sam to call him Jerry and to reach out if she needs anything. |
...
- THE CANON DOCUMENT 4 POINT 5 & 5.txt -- Interludes IF.2 (containment meeting) and IF.3 (arraignment). Primary source for Intermission 4.5 and Book 5 events.
- THE CANON DOCUMENT 6 & 7.txt -- Chapters 87-88 (deposition), 94-96 (trial cross-examination, Liberty Belle note, prosecution challenges), Interlude BA.1 (DVD leadership discussion), and Interlude IF.4 (courthouse attack). Primary source for Book 6 and Book 7 events.
- THE CANON DOCUMENT 14 AND 15.txt -- Chapters 225-231 (hired by Small family, fugitive period communications, release, monitoring conditions, hearing, plea deal). Primary source for Book 15 events.
- THE CANON DOCUMENT 16 AND 17.txt -- Chapter 234 ("Gerald (Insurance)" at community center opening). Source for possible Book 16 appearance.
- intermission-4.5-amnion.md (arc summary) -- Character table entry for Caldwell and Riya Kapoor.
- book-05-mayfly.md (arc summary) -- Chapter IF.3 summary and character table entry.
- book-06-sideshow.md (arc summary) -- Chapter 87 summary and character table entry.
- book-15-severe-weather-warning.md (arc summary) -- Character table entry for Caldwell's Book 15 role.
- illya-fedorov.md (character page) -- Relationship table entry and arc appearance references.
- samantha-small.md (character page) -- Relationship table entry and Book 15 arc references.
- rachel-small.md (character page) -- Skills section reference and Book 15 arc description.
- bianca-agnelli.md (character page) -- Interlude BA.1 reference to DVD leadership's assessment of Caldwell.
- threads-books-4point5-5.md (plot threads) -- Thread 1 (Chernobyl's Trial) connected characters listing.
- threads-books-6-7.md (plot threads) -- Thread 2 (Chernobyl's Sentencing) and Thread 3 (Liberty Belle's Handwritten Note).
- threads-books-14-15.md (plot threads) -- Thread 45 (Caldwell as Legal Bridge) and Thread 46 (Federal De-Gunning).
- MASTER-THREAD-TRACKER.md -- Resolved thread R35 (Caldwell as Sam's lawyer).

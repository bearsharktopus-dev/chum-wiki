...
??? warning "Book 7: Security"
    ...
    **Role:** Mentioned
    ...
    Derek mentions Elias's continued disappearance during the farewell party at the Tacony Music Hall, establishing that Elias has successfully evaded capture since the courthouse attack.
...
??? warning "Book 10: Plume"
    ...
    **Role:** Mentioned
    ...
    Referenced in the context of the expanding three-way conflict between the Auditors, the Kingdom, and Rogue Wave. Elias's earlier activities are part of the backdrop as Rogue Wave emerges as a major threat.
...
??? warning "Book 15: Severe Weather Warning"
    ...
    **Role:** Mentioned
    ...
    Referenced as a wheelchair-using Rogue Wave member. Derek continues operating as Bloodhound II, and the Vysera drug trial that suppresses his werewolf transformation is noted - a drug Elias is separately investigating, suspecting it derives from Snake Oil's research.
